...
`scripts/build_city_stations.py` fills `<CITY>_STATIONS` from NaPTAN - **1,415
stations across ten cities, down from 1,651 on 2026-09-01 (audit I19)** - **read
