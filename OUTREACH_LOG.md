...
| **AI Pilled [operator] #02 / [builder]** | **Tue 23 Sep 2026** (operator, waitlist); builder TBC | London | Builder/operator community; organiser replied 2026-09-17 asking product-or-workflow and inviting Sky Score to the next [builder] event | Replied 2026-09-17: operator = the workflow; accepted [builder] as a second slot for the product. Book the builder date when they answer. |
