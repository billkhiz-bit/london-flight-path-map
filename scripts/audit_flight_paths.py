...
# Mirror of index.html FLIGHT_PATHS as of 2026-05-07. Coordinates are
# [lng, lat] pairs along each polyline. Order matches index.html.
FLIGHT_PATHS = [
    {'name': 'Lambourne Stack', 'airport': 'LHR', 'type': 'arrival', 'freq': 'high',
     'coordinates': [[0.15, 51.65], [0.08, 51.62], [0.02, 51.59], [-0.04, 51.565],
                     [-0.10, 51.54], [-0.18, 51.52], [-0.25, 51.505], [-0.32, 51.495],
                     [-0.38, 51.485], [-0.428, 51.4775]]},
    {'name': 'Biggin Stack', 'airport': 'LHR', 'type': 'arrival', 'freq': 'high',
     'coordinates': [[0.03, 51.33], [-0.02, 51.35], [-0.06, 51.37], [-0.11, 51.39],
                     [-0.16, 51.41], [-0.22, 51.425], [-0.28, 51.44], [-0.34, 51.45],
                     [-0.39, 51.46], [-0.428, 51.4644]]},
    {'name': 'Ockham Stack', 'airport': 'LHR', 'type': 'arrival', 'freq': 'high',
     'coordinates': [[-0.45, 51.28], [-0.44, 51.31], [-0.435, 51.34], [-0.435, 51.37],
                     [-0.435, 51.40], [-0.435, 51.42], [-0.435, 51.44], [-0.435, 51.4644]]},
    {'name': 'Bovingdon Stack', 'airport': 'LHR', 'type': 'arrival', 'freq': 'high',
     'coordinates': [[-0.55, 51.72], [-0.52, 51.68], [-0.50, 51.64], [-0.49, 51.60],
                     [-0.48, 51.56], [-0.47, 51.53], [-0.46, 51.505], [-0.45, 51.4775]]},
    ...
    {'name': 'Approach N', 'airport': 'LGW', 'type': 'arrival', 'freq': 'medium',
     'coordinates': [[-0.10, 51.35], [-0.12, 51.32], [-0.14, 51.28], [-0.16, 51.23],
                     [-0.17, 51.19], [-0.182, 51.1537]]},
    {'name': 'Approach S', 'airport': 'LTN', 'type': 'arrival', 'freq': 'medium',
     'coordinates': [[-0.30, 51.60], [-0.32, 51.65], [-0.34, 51.70], [-0.35, 51.75],
                     [-0.36, 51.80], [-0.368, 51.8747]]},
]
