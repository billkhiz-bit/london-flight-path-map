...
> Version 5.1, last updated 2026-09-15.
...
### 4.3 Growth, dual-anchor scale on the real-terms trend (v5.1)
...
Growth is then a **dual-anchor** scale on that trend. A flat market — prices holding their real value — sits at the midpoint, and each tail is scaled to its own extreme within the cohort:
...
all then clamped to 0–10, with `trend` read as the real-terms figure from v5.1. The fastest-rising borough scores 10, the steepest-falling scores 0, and a market holding its real value scores exactly 5.
