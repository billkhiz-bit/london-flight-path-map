...
How to get `bilal@skyscore.co.uk` (and any other addresses on the domain)
...
|---|---|---|---|---|
| **Cloudflare Email Routing** | Free | Receive only — replies come from the gmail you forward to | Just want to receive `bilal@skyscore.co.uk` and forward to your gmail | Per domain |
...
example, you'll list `bilal@skyscore.co.uk` in outreach but reply from
...
3. **Routes** → **Create address**:
   - Custom address: `bilal@skyscore.co.uk`
...
After setup: any email to `bilal@skyscore.co.uk` lands in your gmail. **Replies
...
5. Create your mailbox: `bilal@skyscore.co.uk`
...
6. Create user `bilal@skyscore.co.uk`
...
4. **Create the mailbox** `bilal@skyscore.co.uk`
